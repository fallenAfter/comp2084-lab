...
using comp2084_lesson81.Models;

namespace comp2084_lesson81
{
    public partial class departments : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack){ //only populates on load if first time running this page. if delete is pressed will not run
                GetDepartments();
            }
